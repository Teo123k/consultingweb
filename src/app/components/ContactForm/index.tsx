...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    fetch('https://formsubmit.co/ajax/contact@cabij.co', {
      method: 'POST',
  ...
  return (
    <section id='contact' className='scroll-mt-12 mt-12 -mx-4 px-4 py-12 bg-neutral-50 dark:bg-neutral-950/20'>
      <div className='container'>
        <div className='relative'>
          <h2 className='mb-6 text-center text-4xl font-semibold'>Let's start a conversation</h2>
          <div className='rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-900/50 p-10'>
            <form
